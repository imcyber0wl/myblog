...
def main(request):
    ...
    return render(request,"main.html",{"articles":articles,'mediaurl':MEDIA_URL})
...
def article(request,num):
    ...
    if not request.user.is_authenticated:
        return render(request,"article.html",{"article":article,"like":'',"nolike":1,"edit":edit,'mediaurl':MEDIA_URL})
    try:
    ...
    return render(request,"article.html",{"article":article,"like":likes.like,"nolike":nolike,"edit":edit,'mediaurl':MEDIA_URL})
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            if request.FILES['img']:
                img = request.FILES['img'] #used to be image
                '''
...
def myprofile(request):
    ...
    return render(request,"myprofile.html",{"profile":profile, "articles":articles,'mediaurl':MEDIA_URL})
